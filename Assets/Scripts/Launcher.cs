...
namespace Com.Josh.Velocity
{
	...
	public class Launcher : MonoBehaviourPunCallbacks
	{
		...
		public GameObject tabSearching;
		public GameObject tabStore;
		public GameObject tabStoreMaster;
		...
		public void TabCloseAll()
		{
			...
			tabSearching.SetActive(false);
			tabStore.SetActive(false);
			tabStoreMaster.SetActive(false);
		}
		...
		public void TabOpenMultiplayer()
		{
			TabCloseAll();
			tabMultiplayer.SetActive(true);
		}

		public void TabOpenSearching()
		{
			TabCloseAll();
			tabSearching.SetActive(true);
		}

		public void TabOpenStore()
		{
			TabCloseAll();
			tabStore.SetActive(true);
		}
		public void TabOpenStoreMaster()
		{
			TabCloseAll();
			tabStoreMaster.SetActive(true);
		}
